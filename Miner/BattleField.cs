...
namespace Miner
{
    public partial class BattleField : Form
    {
        ...
        {
            TimerStop();
            Introduction nextForm = new Introduction();
            this.Hide();
            nextForm.ShowDialog();
            this.Close();
        }
        ...
        {
            MessageBox.Show("Игра разработана командой #4: Игорь, Дмитрий, Иван","О программе");
        }
        ...
        private void MonitorFlags_Tick(object sender, EventArgs e)
        {
            ...
            lblBombs.Text = MapController.bombNumber.ToString();
        }
